...
namespace GUI
{
    public class ExcelExport
    {
        ...
        public const string T_DoanhThuBanHang = "DoanhThuBanHang";
        public const string T_DoanhThuNhapHang = "DoanhThuNhapHang";
        #endregion
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_DoanhThuBanHang:
                   
                    arrByte = File.ReadAllBytes("DoanhThuBanHang.xls").ToArray();
                    break;

                case T_DoanhThuNhapHang:

                    arrByte = File.ReadAllBytes("DoanhThuNhapHang.xls").ToArray();
                    break;
                    #endregion
            }
            // Get stream
        ...
        public bool ExportHoaDon(List<HoaDon> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
          ...
          tongSo = dataSource.Sum(t => t.TongTien).ToString();
            // Create replacer
        ...
        //    replacer.Add(V_TONGSO, "100");
            ...
            return OutSimpleReport(dataSource, replacer, "DoanhThuBanHang", isPrintPreview, ref fileName);
        }


        #endregion

        public bool ExportPhieuNhap(List<PhieuNhap> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            return OutSimpleReport(dataSource, replacer, "DoanhThuNhapHang", isPrintPreview, ref fileName);
        }
